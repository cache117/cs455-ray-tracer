...
public class Main
{
    public static void main(String... args)
    {
        ...
        spheres.add(new Sphere(new Vector(0.2, 0.0, -0.1), 0.075, new Diffuse(new Color(1.0f, 0.0f, 0.0f), new Color(0.5f, 1.0f, 0.5f), 32)));
        spheres.add(new Sphere(new Vector(-0.6, 0.0, 0.0), 0.3, new Diffuse(new Color(0.0f, 1.0f, 0.0f), new Color(0.5f, 1.0f, 0.5f), 32)));
//        triangles.add(new Triangle(new Vector(0.3, -0.3, -0.4), new Vector(0.0f, 0.3f, -0.1f), new Vector(-0.3, -0.3, 0.2), new Diffuse(new Color(1.0f, 1.0f, 1.0f), new Color(0.0f, 0.0f, 1.0f), 32)));
//        triangles.add(new Triangle(new Vector(-0.2, 0.1, 0.1), new Vector(-0.2f, -0.5f, 0.2f), new Vector(-0.2, 0.1, -0.3), new Diffuse(new Color(1.0f, 1.0f, 1.0f), new Color(1.0f, 1.0f, 0.0f), 4)));
...
//        spheres.add(new Sphere(new Vector(0.0, 0.0, 0.0), 0.2322, new Refractive(new Color(1.0, 1.0, 1.0), 1.333)));
//        spheres.add(new Sphere(new Vector(0.25, 0.25, -0.6), 0.1161, new Diffuse(new Color(1.0, 1.0, 0.0), new Color(0.5, 1.0, 0.5), 4)));
//        spheres.add(new Sphere(new Vector(-0.25, 0.25, -0.6), 0.1161, new Diffuse(new Color(1.0, 0.0, 0.0), new Color(0.0, 0.0, 0.0), 4)));
//        spheres.add(new Sphere(new Vector(-0.25, -0.25, -0.6), 0.1161, new Diffuse(new Color(0.0, 0.0, 1.0), new Color(0.0, 0.0, 0.0), 4)));
//        spheres.add(new Sphere(new Vector(0.25, -0.25, -0.6), 0.1161, new Diffuse(new Color(0.0, 1.0, 0.0), new Color(0.0, 0.0, 0.0), 4)));
//        cameraSettings = new CameraSettings(new Vector(0.0, 0.0, 0.0), new Vector(0.0, 0.0, 1.2), new Vector(0.0, 1.0, 0.0), 35);
//        light = new Light(new Vector(0.0, 0.0, 1.0), new Color(1.0, 1.0, 1.0), new Color(0.0, 0.0, 0.0), new Color(0.2, 0.2, 0.2));
