...
public class Main
{
    public static void main(String... args)
    {
        ...
        spheres = new ArrayList<>();
        triangles = new ArrayList<>();
        spheres.add(new Sphere(new Vector(0.0, 0.3, 0.0), 0.2, new Reflective(new Color(0.75f, 0.75f, 0.75f))));
...
//        spheres.add(new Sphere(new Vector(0.0, 0.0, 0.0), 0.2322, new Refractive(new Color(1.0f, 1.0f, 1.0f), 1.333)));
        spheres.add(new Sphere(new Vector(0.0, 0.0, 0.0), 0.2322, new Reflective(new Color(1.0f, 1.0f, 1.0f))));
        ...
        light = new Light(new Vector(0.0, 0.0, 1.0), new Color(1.0f, 1.0f, 1.0f), new Color(0.01f, 0.01f, 0.01f), new Color(0.2f, 0.2f, 0.2f));
        scene = new Scene(spheres, triangles, cameraSettings, light);
